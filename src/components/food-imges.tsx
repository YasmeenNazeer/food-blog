...
export default function FoodGallery() {
  ...
  return (
    <>
      <h1 className="text-center font-semibold  mt-10 mb-8 text-[26px] text-lime-600  font-mono ">
          ...
          {foodItems.map((item) => (
            ...
            >
              <div className="relative w-full h-[150px] sm:h-[180px]">
                ...
                />
                <div className="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-30 transition-opacity duration-300 flex items-center justify-center"></div>
              </div>
